...
public class PpNpsdetail implements Serializable {
	...
	@Column(name = "IS_STOP_CONTRAMOUNT")
	private String IS_STOP_CONTRAMOUNT;
	
	

	public String getIS_STOP_CONTRAMOUNT() {
		return IS_STOP_CONTRAMOUNT;
	}

	public void setIS_STOP_CONTRAMOUNT(String iS_STOP_CONTRAMOUNT) {
		IS_STOP_CONTRAMOUNT = iS_STOP_CONTRAMOUNT;
	}
