...
@NamedQueries({ @NamedQuery(name = "ViewPpEmployeeOnel.findAll", query = "SELECT v FROM ViewPpEmployeeOnel v"),
		...
		@NamedQuery(name = "ViewPpEmployeeOnel.findByRmOfficeid", query = "FROM ViewPpEmployeeOnel WHERE rmOfficeid = ? ORDER BY ppEmployeeEldetailid DESC"),
		...
		@NamedQuery(name = "ViewPpEmployeeOnel.findByPpEmployeeEldetailid", query = "FROM ViewPpEmployeeOnel WHERE ppEmployeeEldetailid = ?") })
