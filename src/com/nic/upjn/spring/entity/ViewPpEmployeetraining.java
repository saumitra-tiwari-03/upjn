...
@NamedQueries({ @NamedQuery(name = "ViewPpEmployeetraining.findAll", query = "SELECT v FROM ViewPpEmployeetraining v"),
		@NamedQuery(name = "ViewPpEmployeetraining.findByPpEmployeetrainingid", query = "FROM ViewPpEmployeetraining WHERE ppEmployeetrainingid = ?"),
		@NamedQuery(name = "ViewPpEmployeetraining.findByPpEmployeemasterid", query = "FROM ViewPpEmployeetraining WHERE ppEmployeemasterid = ?"),
