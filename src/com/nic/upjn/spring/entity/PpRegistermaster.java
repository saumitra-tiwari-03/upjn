...
@XmlRootElement
@NamedQueries({ 
		@NamedQuery(name = "PpRegistermaster.findByPpRegistermasterid", query = "FROM PpRegistermaster WHERE ppRegistermasterid = ?"),
		@NamedQuery(name = "PpRegistermaster.findAll", query = " FROM PpRegistermaster ORDER BY ppRegistermasterid ASC"),
