...
@NamedQueries({
		...
		@NamedQuery(name = "ViewPpEmployeepersonaldetail.findByPpEmployeemasterid", query = "FROM ViewPpEmployeepersonaldetail WHERE ppEmployeemasterid = ?"),
		/*@NamedQuery(name = "ViewPpEmployeepersonaldetail.findcorrectdateformat", 
		query = "SELECT appointmentauthority,TO_CHAR(appointmentfiledate,'dd/mm/yyyy') appointmentfiledate,appointmentfileno,bloodgroup,caste,TO_CHAR(datejoining,'dd/mm/yyyy') datejoining,TO_CHAR(dateofbirth,'dd/mm/yyyy') dateofbirth,designation,district,emailid,employeecode,employmentsubtype,employmenttype,fathername,firstdesignation,firstname,height,homephno,hometown,husbandname,lastname,maritalstatus,masCasteid,masEmploymenttypeid,masMaritalstatusid,masReligionid,middlename,TO_CHAR(mlOpenbaldate,'dd/mm/yyyy') mlOpenbaldate,mlOpenbalance,mobileno,officephno,panno,permanentaddress,personalidentificationmark,pincode,ppDesignationmasterid,ppEmployeeappointmentdetailid,ppEmployeemasterid,ppEmployeepersonaldetailid,presentaddress,religion,retirementage,TO_CHAR(retirementdate,'dd/mm/yyyy') retirementdate,rmOfficeid,sexcode,spouseworkingwithgovt,subphasename FROM ViewPpEmployeepersonaldetail WHERE ppEmployeemasterid = ?"),*/
		@NamedQuery(name = "ViewPpEmployeepersonaldetail.findByEmployeecode", query = "FROM ViewPpEmployeepersonaldetail WHERE employeecode = ?"),
...
public class ViewPpEmployeepersonaldetail implements Serializable {
	...
	public void setRetirementdate(java.sql.Date retirementdate) {
	...
	{
		return (ppDesignationmasterid+"   "+mlOpenbalance+"  "+firstdesignationid);
