...
@XmlRootElement
@NamedQueries({ @NamedQuery(name = "PpRuledetail.findAll", query = "SELECT p FROM PpRuledetail p"),
...
public class PpRuledetail implements Serializable {
	...
	public boolean equals(Object object) {
		...
		if ((this.ppRuledetailid == null && other.ppRuledetailid != null)
				|| (this.ppRuledetailid != null && !this.ppRuledetailid.equals(other.ppRuledetailid))) {
			return false;
		}
		return true;
	}
	...
	public String toString() {
		return "nicupjnentityclasses.PpRuledetail[ ppRuledetailid=" + ppRuledetailid + " ]";
	}
