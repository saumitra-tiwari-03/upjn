...
@XmlRootElement
@NamedQueries({ @NamedQuery(name = "ViewEmployeeSearch.findAll", query = "FROM ViewEmployeeSearch"),
		@NamedQuery(name = "ViewEmployeeSearch.findByPpEmployeemasterid", query = "FROM ViewEmployeeSearch WHERE ppEmployeemasterid = ?"),
		@NamedQuery(name = "ViewEmployeeSearch.findByEmployeecode", query = "FROM ViewEmployeeSearch WHERE employeecode = ?"),
		...
		@NamedQuery(name = "ViewEmployeeSearch.findByRmOfficeid", query = "FROM ViewEmployeeSearch WHERE rmOfficeid = ?"),
