...
@NamedQueries({ @NamedQuery(name = "ViewEmployeeforposting.findAll", query = "SELECT v FROM ViewEmployeeforposting v"),
		@NamedQuery(name = "ViewEmployeeforposting.findByPpEmployeemasterid", query = "FROM ViewEmployeeforposting WHERE ppEmployeemasterid = ?"),
		...
		@NamedQuery(name = "ViewEmployeeforposting.findByEntryOfficeid", query = "SELECT v FROM ViewEmployeeforposting v WHERE v.entryOfficeid = ? ORDER BY ppEmployeemasterid DESC"),
