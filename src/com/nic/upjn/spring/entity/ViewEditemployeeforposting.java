...
@NamedQueries({
		...
		@NamedQuery(name = "ViewEditemployeeforposting.findByPpEmployeemasterid", query = "FROM ViewEditemployeeforposting WHERE ppEmployeemasterid = ?"),
		...
		@NamedQuery(name = "ViewEditemployeeforposting.findByEntryOfficeid", query = "FROM ViewEditemployeeforposting WHERE entryOfficeid = ? ORDER BY ppPostingdetailid DESC"),
