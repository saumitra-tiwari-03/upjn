...
@NamedQueries({
		...
		@NamedQuery(name = "ViewEmplistResumeafterdep.findByPpEmployeemasterid", query = "FROM ViewEmplistResumeafterdep WHERE ppEmployeemasterid = ?"),
		...
		@NamedQuery(name = "ViewEmplistResumeafterdep.findByPpDeputationdetailid", query = "FROM ViewEmplistResumeafterdep WHERE ppDeputationdetailid = ?") })
