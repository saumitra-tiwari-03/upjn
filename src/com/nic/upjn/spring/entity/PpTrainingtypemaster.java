...
@XmlRootElement
@NamedQueries({ @NamedQuery(name = "PpTrainingtypemaster.findAll", query = "FROM PpTrainingtypemaster order by trainingtype"),
		@NamedQuery(name = "PpTrainingtypemaster.findByPpTrainingtypemasterid", query = "FROM PpTrainingtypemaster WHERE ppTrainingtypemasterid = ?"),
...
public class PpTrainingtypemaster implements Serializable {
	...
	@SequenceGenerator(name = "id_Sequence", sequenceName = "SEQ_PP_TRAININGTYPEMASTER", allocationSize = 1)
	@Id
