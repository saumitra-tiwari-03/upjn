...
@NamedQueries({
		...
		@NamedQuery(name = "ViewTerminationdetaillist.findByRmOfficeid", query = "FROM ViewTerminationdetaillist WHERE rmOfficeid = ? ORDER BY ppTerminationdetailid DESC "),
		...
		@NamedQuery(name = "ViewTerminationdetaillist.findByPpTerminationdetailid", query = "FROM ViewTerminationdetaillist WHERE ppTerminationdetailid = ? ORDER BY ppTerminationdetailid DESC"),
