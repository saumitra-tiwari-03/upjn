...
@NamedQueries({
		...
		@NamedQuery(name = "ViewPpEmployeeconfirmation.findByPpEmployeemasterid", query = "FROM ViewPpEmployeeconfirmation WHERE ppEmployeemasterid = ?"),
		@NamedQuery(name = "ViewPpEmployeeconfirmation.findByEmployeecode", query = "FROM ViewPpEmployeeconfirmation WHERE employeecode = ?"),
