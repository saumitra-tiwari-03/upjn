...
@NamedQueries({ @NamedQuery(name = "ViewRmRoleslist.findAll", query = "SELECT v FROM ViewRmRoleslist v"),
		@NamedQuery(name = "ViewRmRoleslist.findByRmRoleid", query = "FROM ViewRmRoleslist WHERE rmRoleid = ?"),
		@NamedQuery(name = "ViewRmRoleslist.findByRolename", query = "SELECT v FROM ViewRmRoleslist v WHERE v.rolename = :rolename"),
		@NamedQuery(name = "ViewRmRoleslist.findByRmOfficeid", query = "FROM ViewRmRoleslist   WHERE rmOfficeid = ? order by rmRoleid DESC"),
