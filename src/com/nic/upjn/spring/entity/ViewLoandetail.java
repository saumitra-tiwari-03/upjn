...
@NamedQueries({ @NamedQuery(name = "ViewLoandetail.findAll", query = "SELECT v FROM ViewLoandetail v"),
		@NamedQuery(name = "ViewLoandetail.findByPpLoandetailid", query = "FROM ViewLoandetail WHERE ppLoandetailid = ?"),
		@NamedQuery(name = "ViewLoandetail.findByPpEmployeemasterid", query = "FROM ViewLoandetail WHERE ppEmployeemasterid = ?"),
