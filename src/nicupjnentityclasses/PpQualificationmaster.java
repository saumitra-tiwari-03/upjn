...
@XmlRootElement
@NamedQueries({ @NamedQuery(name = "PpQualificationmaster.findAll", query = "SELECT p FROM PpQualificationmaster p"),
		@NamedQuery(name = "PpQualificationmaster.findByPpQualificationmasterid", query = "SELECT p FROM PpQualificationmaster p WHERE p.ppQualificationmasterid = :ppQualificationmasterid"),
