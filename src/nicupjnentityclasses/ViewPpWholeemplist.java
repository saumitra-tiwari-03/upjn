...
@XmlRootElement
@NamedQueries({ @NamedQuery(name = "ViewPpWholeemplist.findAll", query = "SELECT v FROM ViewPpWholeemplist v"),
		@NamedQuery(name = "ViewPpWholeemplist.findByPpEmployeemasterid", query = "SELECT v FROM ViewPpWholeemplist v WHERE v.ppEmployeemasterid = :ppEmployeemasterid"),
