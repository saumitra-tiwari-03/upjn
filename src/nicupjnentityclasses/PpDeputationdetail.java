...
public class PpDeputationdetail implements Serializable {
	...
	@JoinColumn(name = "NEXTPOSTINGID", referencedColumnName = "PP_POSTINGDETAILID")
	@ManyToOne
	private PpPostingdetail nextpostingid;
	@OneToMany(mappedBy = "ppDeputationdetailid")
	...
	public PpPostingdetail getNextpostingid() {
		return nextpostingid;
	}

	public void setNextpostingid(PpPostingdetail nextpostingid) {
