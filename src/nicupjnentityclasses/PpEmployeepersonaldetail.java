...
@NamedQueries({
		...
		@NamedQuery(name = "PpEmployeepersonaldetail.findByPpEmployeepersonaldetailid", query = "SELECT p FROM PpEmployeepersonaldetail p WHERE p.ppEmployeepersonaldetailid = :ppEmployeepersonaldetailid"),
