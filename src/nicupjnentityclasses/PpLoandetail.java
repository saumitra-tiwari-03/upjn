...
@NamedQueries({ @NamedQuery(name = "PpLoandetail.findAll", query = "SELECT p FROM PpLoandetail p"),
		@NamedQuery(name = "PpLoandetail.findByPpLoandetailid", query = "SELECT p FROM PpLoandetail p WHERE p.ppLoandetailid = :ppLoandetailid"),
...
public class PpLoandetail implements Serializable {
	...
	@JoinColumn(name = "PP_LOANMASTERID", referencedColumnName = "PP_LOANMASTERID")
	@ManyToOne(optional = false)
	private PpLoanmaster ppLoanmasterid;
	...
	public PpLoanmaster getPpLoanmasterid() {
		return ppLoanmasterid;
	}

	public void setPpLoanmasterid(PpLoanmaster ppLoanmasterid) {
