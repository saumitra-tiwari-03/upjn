...
@NamedQueries({
		...
		@NamedQuery(name = "ViewEmployeepostingdetail.findByPpEmployeemasterid", query = "SELECT v FROM ViewEmployeepostingdetail v WHERE v.ppEmployeemasterid = :ppEmployeemasterid"),
