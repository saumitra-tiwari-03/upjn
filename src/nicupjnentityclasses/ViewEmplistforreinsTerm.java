...
@NamedQueries({
		...
		@NamedQuery(name = "ViewEmplistforreinsTerm.findByRmOfficeid", query = "SELECT v FROM ViewEmplistforreinsTerm v WHERE v.rmOfficeid = :rmOfficeid"),
		@NamedQuery(name = "ViewEmplistforreinsTerm.findByPpTerminationdetailid", query = "SELECT v FROM ViewEmplistforreinsTerm v WHERE v.ppTerminationdetailid = :ppTerminationdetailid"),
