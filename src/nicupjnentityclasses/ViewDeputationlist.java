...
@NamedQueries({ @NamedQuery(name = "ViewDeputationlist.findAll", query = "SELECT v FROM ViewDeputationlist v"),
		...
		@NamedQuery(name = "ViewDeputationlist.findByEmployeecode", query = "SELECT v FROM ViewDeputationlist v WHERE v.employeecode = :employeecode"),
		...
		@NamedQuery(name = "ViewDeputationlist.findByRmOfficeid", query = "SELECT v FROM ViewDeputationlist v WHERE v.rmOfficeid = :rmOfficeid"),
		...
		@NamedQuery(name = "ViewDeputationlist.findByPpDeputationdetailid", query = "SELECT v FROM ViewDeputationlist v WHERE v.ppDeputationdetailid = :ppDeputationdetailid"),
