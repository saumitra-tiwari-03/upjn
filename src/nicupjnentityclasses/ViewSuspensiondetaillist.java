...
@NamedQueries({
		...
		@NamedQuery(name = "ViewSuspensiondetaillist.findByEmployeecode", query = "SELECT v FROM ViewSuspensiondetaillist v WHERE v.employeecode = :employeecode"),
		...
		@NamedQuery(name = "ViewSuspensiondetaillist.findByRmOfficeid", query = "SELECT v FROM ViewSuspensiondetaillist v WHERE v.rmOfficeid = :rmOfficeid"),
		...
		@NamedQuery(name = "ViewSuspensiondetaillist.findByPpSuspensiondetailid", query = "SELECT v FROM ViewSuspensiondetaillist v WHERE v.ppSuspensiondetailid = :ppSuspensiondetailid"),
