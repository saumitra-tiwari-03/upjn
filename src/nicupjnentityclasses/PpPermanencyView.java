...
@NamedQueries({ @NamedQuery(name = "PpPermanencyView.findAll", query = "SELECT p FROM PpPermanencyView p"),
		@NamedQuery(name = "PpPermanencyView.findByPpEmployeemasterid", query = "SELECT p FROM PpPermanencyView p WHERE p.ppEmployeemasterid = :ppEmployeemasterid"),
		@NamedQuery(name = "PpPermanencyView.findByEmployeecode", query = "SELECT p FROM PpPermanencyView p WHERE p.employeecode = :employeecode"),
