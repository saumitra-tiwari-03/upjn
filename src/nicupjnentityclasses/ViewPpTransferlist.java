...
@NamedQueries({ @NamedQuery(name = "ViewPpTransferlist.findAll", query = "SELECT v FROM ViewPpTransferlist v"),
		...
		@NamedQuery(name = "ViewPpTransferlist.findByRmOfficeid", query = "SELECT v FROM ViewPpTransferlist v WHERE v.rmOfficeid = :rmOfficeid"),
		...
		@NamedQuery(name = "ViewPpTransferlist.findByPpTransferdetailid", query = "SELECT v FROM ViewPpTransferlist v WHERE v.ppTransferdetailid = :ppTransferdetailid"),
		...
		@NamedQuery(name = "ViewPpTransferlist.findByOfficefromid", query = "SELECT v FROM ViewPpTransferlist v WHERE v.officefromid = :officefromid"),
