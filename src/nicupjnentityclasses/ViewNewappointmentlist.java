...
@XmlRootElement
@NamedQueries({ @NamedQuery(name = "ViewNewappointmentlist.findAll", query = "SELECT v FROM ViewNewappointmentlist v"),
		@NamedQuery(name = "ViewNewappointmentlist.findByPpEmployeemasterid", query = "SELECT v FROM ViewNewappointmentlist v WHERE v.ppEmployeemasterid = :ppEmployeemasterid"),
		...
		@NamedQuery(name = "ViewNewappointmentlist.findByEntryOfficeid", query = "SELECT v FROM ViewNewappointmentlist v WHERE v.entryOfficeid = :entryOfficeid") })
