...
@NamedQueries({ @NamedQuery(name = "ViewRmRolesforemployee.findAll", query = "SELECT v FROM ViewRmRolesforemployee v"),
		@NamedQuery(name = "ViewRmRolesforemployee.findByPpEmployeemasterid", query = "SELECT v FROM ViewRmRolesforemployee v WHERE v.ppEmployeemasterid = :ppEmployeemasterid"),
