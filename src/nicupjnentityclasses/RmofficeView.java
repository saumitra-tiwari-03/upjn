...
@XmlRootElement
@NamedQueries({ @NamedQuery(name = "RmofficeView.findAll", query = "SELECT r FROM RmofficeView r"),
		@NamedQuery(name = "RmofficeView.findByRmOfficeid", query = "SELECT r FROM RmofficeView r WHERE r.rmOfficeid = :rmOfficeid"),
