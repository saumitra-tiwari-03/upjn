        ...
        for (x in oRequired) {
            ...
            if ((field.type == 'hidden' ||
                ...
                if (field.type == "select-one") {
					...
					/* Modified By: Mohit Singhal
					 * Modified Date: 27/03/2006
					 * Purpose : To implement validation on Combo
					 */
					if (value == "-1") {
...
//	 2 if date2 is is equal to date1
//  -1 if either of the dates is in an invalid format
// -------------------------------------------------------------------
	function compareDates_in(date1,date2) { // (fromDate, toDate)

		var date1_array=date1.split("/");
		var date2_array=date2.split("/");

		var newdate1=new Date(date1_array[2],date1_array[1]-1,date1_array[0]);
		var newdate2=new Date(date2_array[2],date2_array[1]-1,date2_array[0]);

		if (newdate1 > newdate2) { // If fromDate > toDate
			//alert ("fromDate > toDate");
			return 1;
		} else if (newdate1 < newdate2) { // If fromDate < toDate
			//alert ("fromDate < toDate");
			return 0;
		} else if (newdate1 = newdate2) { // If fromDate = toDate
			//alert ("fromDate = toDate");
...
//   Get month & year and returns number of days in that month.
...
//---------- This method is added by deveki
