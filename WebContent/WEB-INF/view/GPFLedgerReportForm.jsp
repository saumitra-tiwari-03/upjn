...
<body>
	...
	<div style="height: 100%; width: 100%;">
		...
		<div align="center"
			...
			<form action="/UPJN/getgpfledgerreport">
													...
													<table border="0" width="100%">
														...
														<tr>
															...
															<td class="cell_bg" valign="top" align="left"><input
																maxlength="6" type="text" class="txt_medium" name="employeecode" /> <span
																class="star">*</span></td>
														</tr>
														...
														<tr>
															<td class="cell_bg" valign="top">&nbsp;</td>
															<td class="cell_bg" valign="top" align="center" width="43%">Year</td>
