...
<html>
<head>
<title>U.P JAL NIGAM-Monthly Pay Bill</title>
...
<form name="processPayActionForm" method="post" action="/UPJN/payBillExection">
				...
				<td align="center" valign="top"><table width="60%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td valign="top" class="table_bg"><table width="100%" border="0" cellspacing="0" cellpadding="3">
									<tr>
										<td colspan="3" valign="top" class="table_head" align="left">
											Prepare Monthly Pay Bill
										</td>
										<td align="center" valign="middle" class="table_head">
											<a href="UpdatePayDetail.do?method=begin">
												<img src="images/cross.jpeg" height="16" width="16" border="0" hspace="0">
											</a>
										</td>
									</tr>
									<tr>
									...
									<tr>
										<td align = "center" valign="top" class="cell_bg" colspan="3">
											<input type="submit" name="ProcessPayLogicExecuetion" value="Process Pay"  class="btn_medium" >&nbsp;
											
											
											<input type="submit" name="partlyProcessPayLogicExecuetion" value="Unpaid/Partly Paid"  class="btn_large" title="Generate paybill of single employee of this register for selected month and year">
										</td>
									</tr>
									</table></td>
								</tr>
