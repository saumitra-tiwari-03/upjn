...
<title>U.P JAL NIGAM-Termination Employee Search Form</title>
<link href="resources/css/upjn.css" rel="stylesheet" type="text/css">
</head>

<body>
	<form action="/UPJN/terminationEmployeeSearchByCondtion" method="post">
													...
													<td valign="top" class="table_bg"><table width="100%"
															...
															<tr>
																<td align="left" valign="top" class="table_head">
																	Employee Termination - Employee Search</td>
																	<td align="center" valign="middle" class="table_head">
																			<a href="/UPJN/employeeTerminationDetails"> <img alt=""
														...
														<table width="100%" border="0" cellspacing="1"
															...
															<tr>
																...
																<td align="left" valign="top" class="cell_bg">
																	First Name</td>
																<td align="left" valign="top" class="cell_bg"><input
																	type="text" name="firstname" class="txt_medium"
																	maxlength="250"></td>
															</tr>
															<tr>
																<td valign="top" class="cell_bg">&nbsp;</td>
																<td align="left" valign="top" class="cell_bg">Last
																	Name</td>
																<td align="left" valign="top" class="cell_bg"><input
																	type="text" name="lastname" class="txt_medium"
																	maxlength="250"></td>
															</tr>
															<tr>
																<td width="3%" valign="top" class="cell_bg">&nbsp;</td>
