...
<title>U.P JAL NIGAM-Relieve For Deputation Employee Search</title>
<link href="resources/css/upjn.css" rel="stylesheet" type="text/css">
</head>

<body>
	<form action="/UPJN/relieveDeputationEmployeeSearchByCondtion"
		method="post">
													...
													<td valign="top" class="table_bg"><table width="100%"
															...
															<tr>
																<td align="left" valign="top" class="table_head">
																	...
																	Relieve For Deputation - Employee Search</td>
