...
<title>U.P JAL NIGAM- Deputation Employee Search </title>
...
<body>
<form action="/UPJN/populateemployeeRelieveDeputationDetails" method="post">
<input type="hidden" name="employeecode" value="${employee}"> 
						...
						<td align="center" class="table_bg" valign="top"><table
								...
								<tr>
									<td colspan="8" valign="top" class="table_head" align="left">
										Relieve For Deputation - List of Employees</td>
									<td colspan="1" valign="top" class="table_head" align="right">
										<a href="/UPJN/relieveForDeputationEmployeeSearch"><u>Search Again</u></a>
									</td>
									<td align="center" valign="middle" class="table_head">
																			<a href="/UPJN/relievefordeputation"> <img alt=""
															...
															<c:choose>
																<c:when test="${list!=null}">
																	<c:forEach items="${list}" var="list">
																		...
																		<tr>
																			<td width="7%"><input type="radio" name="employee" value="${list.employeecode}"></td>
										...
										<td width="15%">${list.designation}</td>
											...
											<tr>
																<td colspan="5" align="center" valign="top" class="cell_bg">																	
																	<input type="submit" class="btn_medium" value="Submit" onclick="javascript:putValues()"/>
																	</td>
																	</tr>
