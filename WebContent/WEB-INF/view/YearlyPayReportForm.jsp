...
<body>
	...
	<div style="height: 100%; width: 100%;">
		...
		<div
			...
			<form action="/UPJN/YearlyPayReport">
												...
												<td valign="top" class="table_bg">
													<table border="0" width="100%">
														...
														<tr>
															...
															<td class="table_head" colspan="4">Report - Monthly
																Pay</td>
														</tr>
														...
														<tr>
															...
															<td class="cell_bg" valign="top" align="left" width="43%">Employee Code</td>

															<td width="49%" align="left" valign="middle" class="cell_bg" >
