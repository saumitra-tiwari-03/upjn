...
<title>U.P JAL NIGAM-Relieve From Service Employee Search List</title>
...
<body>
<form action="/UPJN/populateRelieveFromServiceEmployee" method="post">
						...
						<td align="center" class="table_bg" valign="top"><table
								...
								<tr>
									<td colspan="8" valign="top" class="table_head" align="left">
										Relieve From Service - List of Employees</td>
									<td colspan="1" valign="top" class="table_head" align="right">
										<a href="/UPJN/suspensionEmployeeSearch"><u>Search Again</u></a>
									</td>
									<td align="center" valign="middle" class="table_head">															
														<a href="/UPJN/relieveFromService">
