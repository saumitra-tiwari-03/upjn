...
<title>U.P JAL NIGAM-Relieve Service Search</title>
<link href="resources/css/upjn.css" rel="stylesheet" type="text/css">
</head>

<body>
<form action="/UPJN/relieveFromServiceEmployeeSearchByCondtion" method="post">
											...
											<td valign="top" class="table_bg"><table width="100%" border="0" cellspacing="1" cellpadding="3">                      
												<tr>
													<td align="left" valign="top" class="table_head">
														Relieve From Service - Employee Search
													</td>
