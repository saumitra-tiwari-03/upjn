...
<title>U.P JAL NIGAM-Pay Role SearchList</title>
<link href="resources/css/upjn.css" rel="stylesheet" type="text/css">
</head>
<body>

<form action="/UPJN/searchEmployeePayroll" method="post">
						...
						<td align="center" class="table_bg" valign="top"><table
								...
								<tr>
									<td colspan="8" valign="top" class="table_head" align="left">
										PayRoll Search - List of Employees</td>
									<td colspan="1" valign="top" class="table_head" align="right">
										<a href="/UPJN/"><u>Search Again</u></a>
									</td>
								</tr>
										...
										<table width="100%" align="center" class="cell_bg"
																				...
																				<c:forEach items="${list}" var="list">
																					...
																					<tr>
																						<td width="7%"><input type="radio"
																							name="employeecode" value="${list.employeecode}"></td>
											...
											<tr>
												<td colspan="5" align="center" valign="top" class="cell_bg">
													...
													name="actionSubmit" onclick="javascript:putValues()" />
												</td>
											</tr>
