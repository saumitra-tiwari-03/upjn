...
<title>U.P JAL NIGAM- Change Rights</title>
...
<body style="margin: 0px 0px 0px 0px;">
	...
	<div style="height: 100%; width: 100%;">
		...
		<div style="height: 100%; width: 79%; float: left; padding-top: 10px;">
			<form action="/UPJN/changeAssignRoles">
															...
															<td valign="top" class="table_bg"><table
																	...
																	<tr>
																		...
																		<td width="95%" align="left" valign="top"
																			class="table_head">Assign Office Admin-Change
																			Rights</td>
																...
																<table style="width: 100%;" border="0">
																	...
																	<tr>
																		<td align="right" colspan="2" class="bold">Change
																			Rights of Office Admin : ${employeename}</td>
																	</tr>
																	<tr>
																		<td align="right" colspan="3" class="bold">Office
																			Name : ${office}</td>
																	</tr>
																	<tr>
