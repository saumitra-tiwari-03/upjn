...
<title>U.P JAL NIGAM-Resume After Deputation</title>
			 ...
			 <!--  -->
				...
				<table width="90%" class="table_bg" cellpadding="3" cellspacing="3"
					...
					<tr>
												...
												Resume After Deputation - List of Employees</td>
											</tr>
					<tr>
						<td>
							<div style="overflow-y: scroll; height: 600px">
								<table width="100%" id="myTable" cellpadding="0" cellspacing="1"
									...
									<thead id="h" align="center">
										<tr>
											...
											<th id="t" width="18%"><img alt=""
												...
												src="resources/images/sort.gif">Relieving office(UPJN)</th>
									...
									<c:forEach items="${list}" var="list">
																<tr>
																	<input type="hidden" id="ppDeputationdetailid"
																		value="${list.ppDeputationdetailid}"
																		name="ppDeputationdetailid" />
																	<td>${list.employeecode}</td>
																	<td>${list.employeename}</td>
																	<td>${list.designation}</td>
																	<td>${list.employmenttype}</td>
																	<td>${list.employmentsubtype}</td>
																	<td>${list.returningfrom}</td>
																	<td>
																	<td><a
																		href="/UPJN/populateResumeAfterDeuptation?ppDeputationdetailid=<c:out value="${list.ppDeputationdetailid}"/>"><u>Resume</u></a></td>
