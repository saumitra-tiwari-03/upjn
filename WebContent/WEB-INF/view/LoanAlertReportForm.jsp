...
<body>
	...
	<div style="height: 100%; width: 100%;">
		...
		<div
			...
			<form action="/UPJN/LoanAlertReport">
												...
												<td valign="top" class="table_bg">
													<table border="0" width="100%">
														...
														<tr>
															...
															<td class="table_head" colspan="4">Report - Loan
																Alert</td>
														</tr>
														...
														<tr>
															<td class="cell_bg" valign="top">&nbsp;</td>
															<td class="cell_bg" valign="top" align="left" width="43%">Loan Alert</td>

															<td align="left"><select class="cmb_medium"
																name="loantype" required>
																	<option value="-1">[Select Loan Alert]</option>
