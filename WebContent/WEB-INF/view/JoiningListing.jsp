...
<title>U.P JAL NIGAM-Employee Joining List</title>
				...
				<table width="90%" class="table_bg" cellpadding="3" cellspacing="3"
					...
					<tr>
						<td colspan="9" valign="top" class="table_head" align="left">
							Join Employee- List of Employees</td>
					</tr>
					<tr>
						<td>
									...
									<tbody id="b" align="center">
										...
										<c:forEach items="${edit}" var="list">
											<tr>
												...
												<td><a
													href="/UPJN/joinEmployeeDetails?ppEmployeemasterid=<c:out value="${list.ppEmployeemasterid}"/>&ppTransferdetailid=<c:out value="${list.ppTransferdetailid}"/>">
														Join Employee</a></td>
											</tr>
										</c:forEach>
									</tbody>
