...
<title>UP Jal Nigam - Deduction / Loan Schedules</title>
...
<body>
	...
	<div style="height: 100%; width: 100%;">
		...
		<div
			...
			<form action="/UPJN/DeductionScheduleReport" method="post">
												...
												<td valign="top" class="table_bg">
													<table border="0" width="100%">
														...
														<tr>
															...
															<td class="table_head" colspan="4">Schedule Report Form </td>
														</tr>
														...
														<tr>
															<td class="cell_bg" valign="top">&nbsp;</td>
															<td class="cell_bg" valign="top" align="left" width="43%">Schedule Report for</td>

															<td align="left"><select class="cmb_medium"
																name="pp_ScheduleMasterID" required>
																	<option value="-1">[Select Schedule]</option>
																		<c:forEach var="c" items="${scheduleList}">
																		<option value="${c.ppSchedulemasterid}">
																		${c.schedulename}
																			</option>
																	</c:forEach>
															</select>
															...
															<select class="cmb_medium"
																name="pp_RegisterMasterID" required>
																	<option value="-1">[Select Register]</option>
																	<c:forEach var="c" items="${registerList}">
																		<option value="${c.ppRegistermasterid}">
																		${c.registername}
																			</option>
																	</c:forEach>
															</select>
