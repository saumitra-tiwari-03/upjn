...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#isnps").val($("#NPSGPF").val());
	//	$("#gpfno").val($("#ISNPSCOL").val());
...
<script type="text/javascript">
	function changeTextBox() {
		if (document.forms[0].isnps.value == "N") {
			document.forms[0].gpfno.value = "PRAN NO"
		}
		if (document.forms[0].isnps.value == "G") {
			document.forms[0].gpfno.value = "GPF NO"
		}
	}
</script>
...
<body style="margin: 0px 0px 0px 0px;">
	...
	<div style="height: 100%; width: 100%;">
		...
		<div style="height: 100%; width: 79%; float: left; padding-top: 10px;">
			<form method="post" action="/UPJN/updateEmpPayDetail">
				...
				<table border="0" cellpadding="0" cellspacing="0" width="100%">
					...
					<tr>
						<td valign="top" class="msg"><c:choose>

								<c:when test="${isComplete == true }">
									Process Completed Successfully
									</c:when>
								<c:when test="${isComplete == false }">
																...
																<table width="100%" border="0" cellspacing="1"
																			...
																			<table width="100%" border="0" cellspacing="1"
																				...
																				<tr>
																					...
																					<td valign="middle" class="tabdefault"
																						...
																						width="25%"><a
																						href="/UPJN/payandalwdetails?ppEmployeeMasterID=${ppempmasterid}&sectionname=${sectionname}&register=${registername}"><u></u>
																							<strong>Pay & Allowance Detail</strong> </a></td>
																					<td valign="middle" class="tabdefault"
																						bordercolor="#4390E0" bgcolor="#4390E0"
																						width="25%"><a
																						href="/UPJN/populateEmployeeDeductionDetail?ppEmployemasterID=${ppempmasterid}&sectionname=${sectionname}&register=${registername}"><u></u>
																							<strong>Deduction Detail</strong> </a></td>

																					<td valign="middle" class="tabdefault"
																						bordercolor="#4390E0" bgcolor="#4390E0"
																						width="25%"><a
																						href="/UPJN/populateEmployeeLoanDetail?ppEmployemasterID=${ppempmasterid}&sectionname=${sectionname}&register=${registername}"><u></u>
																	...
																	<tr>
																		...
																		<td width="48%" align="left" valign="top"
																			...
																			maxlength="100" size="30" readonly="readonly"
																	...
																	<tr>
																		...
																		<td align="left" valign="middle" class="cell_bg">
																			...
																			value="${employeecode}" maxlength="25" size="25"
																			readonly="readonly" class="txt_noborder"> <input
																			type="hidden" name="pp_EmployeeMasterID"
																			value="${ppempmasterid}" />
																		</td>
																	</tr>
																	...
																	<tr>
																		...
																		<td align="left" valign="top" class="cell_bg"><input
																			...
																			value="${employeename}" maxlength="100" size="25"
																	...
																	<tr>
																		...
																		<td align="left" valign="middle" class="cell_bg">
																			...
																			value="${designation}" maxlength="100" size="25"
																	...
																	<tr>
																		...
																		<td align="left" valign="top" class="cell_bg"
																			id="gpfno">
																			<%-- <c:if test="${ISNPSCOL != null}">
																	     ${ISNPSCOL}
																	</c:if>	 --%> <input type="text" value="${ISNPSCOL}"
																			style="border: 0px" id="gpfno" readonly="readonly"
																			name="gpfno">
																		...
																		<td align="left" valign="top" class="cell_bg"
																			...
																			class="txt_small" id="empPayDetailForm"
																			value="${gpfacno}"> <span class="star">*[Max
																				25 char.]</span></td>
																	</tr>
																	<tr>
																		<td valign="top" class="cell_bg">&nbsp;</td>
																		<td align="left" valign="top" class="cell_bg">
																			PAN No</td>
																		<td align="left" valign="top" class="cell_bg"><input
																			type="text" name="panno" maxlength="25" size="25"
																			value="${panno}" class="txt_small"></td>
																	</tr>
																	...
																	<tr>
																		...
																		</select> <input type="hidden" id="paymentmodeID"
																			value="${sysPaymentmodeid}" /> <input type="hidden"
																			id="NPSGPF" value="${isnps}" /> <input type="hidden"
																			id="ISNPSCOL" value="${ISNPSCOL}" />
																	...
																	<tr>
																		...
																		<td align="left" valign="middle" class="cell_bg">
																			...
																			maxlength="100" size="25" readonly="readonly"
																			value="${emptype }" class="txt_noborder"> <input
																			type="hidden" name="mas_EmploymentTypeID">
																		</td>
																	</tr>
																		...
																		<td align="left" valign="middle" class="cell_bg">
																			...
																			name="fwa_BankAccountID" class="cmb_medium">
																				<c:forEach var="d" items="${fwabankaccount}">
																					<option value="${d.fwaBankaccountid}">${d.acNumber}</option>
																				</c:forEach>
																		</select>
																	...
																	<tr>
																		...
																		<td align="left" valign="top" class="cell_bg">
																			Bank A/C No.</td>
																		<td align="left" valign="middle" class="cell_bg">
																			<input type="text" name="bankAccNo" maxlength="20"
																			value="${bankaccno}" size="30" class="txt_small">
																			<span class="star">*[Max 20 char.]</span>
																		</td>
																	</tr>
																	...
																	<tr>
																		...
																		<td align="left" valign="top" class="cell_bg">
																			Bank Name</td>
																		<td align="left" valign="top" class="cell_bg"><input
																			type="text" name="bank_Name" value="${bankname}"
																			class="txt_medium">
																	</tr>
																	...
																	<tr>
																		...
																		<td align="left" valign="top" class="cell_bg">
																			Branch Name</td>
																		<td align="left" valign="top" class="cell_bg"><input
																			type="text" name="branch_Name" value="${branchname}"
																			class="txt_medium">
																	</tr>
																	...
																	<tr>
																		...
																		<td align="left" valign="top" class="cell_bg">
																			IFSC CODE</td>
																		<td align="left" valign="top" class="cell_bg"><input
																			type="text" name="ifsc_code" value="${ifsccode}"
																			class="txt_medium">
																	</tr>
																	...
																	<tr>
																		...
																		<td class="cell_bg" valign="top" align="left">
																			Salary Percent</td>
																		<td align="left" valign="middle" class="cell_bg">
																			<select id="salaryPercent" name="salaryPercent"
																			class="cmb_medium">
																		...
																		</select> <input type="hidden" name="salarypercent"
																			id="salarypercentID" value="${salarypercent}" />
																	...
																	<tr>
																		...
																		<td align="left" valign="middle" class="cell_bg">
																			...
																			<input type="checkbox" name="txtNoOfDays"
																			value="null" id="nodCheck"
																			onclick="return onCheck();"> 
																																				
																		<input	value="${nod}"	type="text" name="noOfDays" maxlength="2"
																	...
																	<tr>
																		...
																		<td align="left" valign="top" class="cell_bg">
																			Head Quarter</td>
																		<td align="left" valign="middle" class="cell_bg">
																			<input type="text" name="headQuarter" maxlength="15"
																			value="${hq }" size="30" class="txt_small"> <span
																	...
																	<tr>
																		...
																		<td align="right" valign="top" class="cell_bg"><input
																			type="submit" name="none" value="Submit"
																			class="btn_medium"></td>
